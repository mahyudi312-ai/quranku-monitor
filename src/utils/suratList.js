export const suratList = [
  ...
  { no: 74, nama: "Al-Muddatstsir", ayat: 56 },
  ...
  { no: 88, nama: "Al-Gasyiyah", ayat: 26 },
...
export function getSuratByNomor(no) {
  return suratList.find((s) => s.no === Number(no));
}